...
All notable changes to md2jira will be documented here.
...
- **Configuration**
  - YAML config file support (`.md2jira.yaml`)
  - TOML config file support (`.md2jira.toml`)
  - pyproject.toml support (`[tool.md2jira]`)
...
For the complete version history, see the [CHANGELOG.md](https://github.com/adriandarian/md2jira/blob/main/CHANGELOG.md) in the repository.
