...
```python
from md2jira.application.commands import Command, CommandResult
...
```python
from md2jira.core.domain.events import DomainEvent, EventBus
...
```python
from md2jira.core.ports import IssueTrackerPort, IssueData
...
Extend md2jira behavior without modifying core code:
