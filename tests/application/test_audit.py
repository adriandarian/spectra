...
class TestAuditTrailRecorder:
    ...
    def test_records_story_matched(self):
        ...
        event_bus.publish(StoryMatched(
            story_id="US-001",
            issue_key="PROJ-101",
    ...
    def test_records_story_updated(self):
        ...
        event_bus.publish(StoryUpdated(
            issue_key="PROJ-101",
    ...
    def test_records_subtask_created(self):
        ...
        event_bus.publish(SubtaskCreated(
            parent_key="PROJ-101",
    ...
    def test_records_comment_added(self):
        ...
        event_bus.publish(CommentAdded(
            issue_key="PROJ-101",
    ...
    def test_records_sync_completed(self):
        ...
        event_bus.publish(SyncCompleted(
            epic_key="PROJ-100",
            stories_matched=5,
            stories_updated=3,
            subtasks_created=10,
...
class TestCLIArgumentParsing:
    ...
    def test_audit_trail_argument(self):
        ...
        args = parser.parse_args([
            "--markdown", "epic.md",
            "--epic", "PROJ-123",
            "--audit-trail", "/var/log/audit.json",
        ])
