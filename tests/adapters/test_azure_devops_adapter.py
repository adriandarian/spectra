...
class TestAzureDevOpsAdapter:
    ...
    def test_get_epic_children(self, adapter, mock_client):
        ...
        mock_client.get_work_item_children.return_value = [
            {"id": 101, "fields": {"System.Title": "Child 1", "System.State": "New", "System.WorkItemType": "User Story"}, "relations": []},
            {"id": 102, "fields": {"System.Title": "Child 2", "System.State": "Active", "System.WorkItemType": "User Story"}, "relations": []},
        ]
