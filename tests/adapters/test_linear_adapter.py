...
class TestLinearAdapter:
    ...
    def test_get_issue_with_subtasks(self, adapter, mock_client):
        ...
        mock_client.get_issue.return_value = {
            ...
            "children": {
                "nodes": [
                    {"id": "child-1", "identifier": "ENG-457", "title": "Subtask 1", "state": {"name": "Done"}},
                    {"id": "child-2", "identifier": "ENG-458", "title": "Subtask 2", "state": {"name": "Todo"}},
                ]
            },
            "comments": {"nodes": []},
        }
    ...
    def test_get_epic_children_as_project(self, adapter, mock_client):
        ...
        mock_client.get_project_issues.return_value = [
            {"id": "issue-1", "identifier": "ENG-101", "title": "Story 1", "state": {"name": "Todo"}, "assignee": None, "estimate": None, "children": {"nodes": []}, "comments": {"nodes": []}},
            {"id": "issue-2", "identifier": "ENG-102", "title": "Story 2", "state": {"name": "Done"}, "assignee": None, "estimate": None, "children": {"nodes": []}, "comments": {"nodes": []}},
        ]
