...
class TestHookManager:
    ...
    def test_trigger_priority_order(self, hook_manager):
        ...
        hook_manager.register(Hook("last", HookPoint.BEFORE_SYNC, 
                              lambda x: order.append("last"), priority=100))
        hook_manager.register(Hook("first", HookPoint.BEFORE_SYNC,
                              lambda x: order.append("first"), priority=10))
        hook_manager.register(Hook("middle", HookPoint.BEFORE_SYNC,
    ...
    def test_trigger_cancel(self, hook_manager):
        ...
        hook_manager.register(Hook("after", HookPoint.BEFORE_SYNC,
