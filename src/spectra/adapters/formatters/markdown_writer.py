...
class MarkdownWriter:
    ...
    def _write_subtasks_table(self, subtasks: list[Subtask]) -> list[str]:
        ...
        for i, subtask in enumerate(subtasks, start=1):
            ...
            lines.append(
                f"| {number} | {name} | {desc} | {subtask.story_points} | {status_text} |"
            )
...
class MarkdownUpdater:
    ...
    def update_story_in_content(
        ...
        updated = re.sub(pattern, replace_story, content)
        return updated
    ...
    def update_field_in_story(
        ...
        def update_field(match: re.Match) -> str:
            ...
            updated_story = re.sub(field_pattern, replacement, story_content)
