...
class JiraBatchClient:
    ...
    def bulk_update_issues(
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            futures = {
                executor.submit(update_single, i, update): i
                for i, update in enumerate(updates)
            }
    ...
    def bulk_update_descriptions(
        ...
        """
        update_dicts = [
            {"key": key, "fields": {"description": desc}}
        ...
        def transition_single(
            ...
            try:
                ...
                if transition_id is None:
                    ...
                    return (idx, key, f"No transition to '{target_status}' available. Options: {available_names}")
    ...
    def bulk_get_issues(
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            futures = {
                executor.submit(fetch_single, i, key): i
