...
class ConfluenceAdapter(DocumentOutputPort):
    ...
    def get_page_by_title(self, space_key: str, title: str) -> Optional[PageData]:
        """Find page by title."""
    ...
    def format_epic_content(self, epic: Epic) -> str:
        ...
        for story in epic.stories:
            ...
            parts.append(f"<p><strong>Story Points:</strong> {story.story_points} | "
    ...
    def format_story_content(self, story: UserStory) -> str:
        ...
        parts.append(self._status_panel(
        ...
        if story.commits:
            ...
            for commit in story.commits:
                parts.append(f"<li><code>{html.escape(commit.sha[:8])}</code> - "
        ...
        if story.external_url:
            ...
            parts.append(f'<p><a href="{html.escape(story.external_url)}">'
                        f"View in Issue Tracker</a></p>")
