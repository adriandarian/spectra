...
class TemplateGenerator:
    ...
    def preview(self, epic_key: str) -> Optional[str]:
        """
    ...
    def _fetch_epic(self, epic_key: str, result: GenerateResult) -> Optional[dict]:
    ...
    def _generate_markdown(
        ...
        lines.append("> Edit this file and sync back with: spectra --markdown {file} --epic {epic_key} --execute")
    ...
    def _get_status_emoji(self, status: str) -> str:
        ...
        if status_lower in ("done", "closed", "resolved"):
            ...
            return "🚫"
        elif status_lower in ("ready", "ready for dev"):
            return "📋"
        else:
            return "📋"
...
def run_generate(args, console: Console) -> int:
    ...
    if result.success and not dry_run:
        ...
        console.item(f"Sync changes: spectra --markdown {result.output_path} --epic {epic_key} --execute")
