...
class Subtask:
    ...
    def matches(self, other: Subtask) -> bool:
        ...
        return (
            self_normalized in other_normalized or 
            other_normalized in self_normalized
        )
...
class UserStory:
    ...
    def matches_title(self, other_title: str) -> bool:
        ...
        return (
            self_normalized == other_normalized or
            self_normalized in other_normalized or
            other_normalized in self_normalized
        )
    ...
    def find_subtask(self, name: str) -> Optional[Subtask]:
...
class Epic:
    ...
    def find_story(self, story_id: StoryId) -> Optional[UserStory]:
        """Find a story by ID."""
    ...
    def find_story_by_title(self, title: str) -> Optional[UserStory]:
