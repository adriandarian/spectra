...
class StateStore:
    ...
    Default location: ~/.md2jira/state/
    """
    
    DEFAULT_STATE_DIR = Path.home() / ".md2jira" / "state"
    ...
    def __init__(self, state_dir: Optional[Path] = None):
        ...
        Args:
            state_dir: Directory to store state files. Defaults to ~/.md2jira/state/
        """
    ...
    def load(self, session_id: str) -> Optional[SyncState]:
        """
