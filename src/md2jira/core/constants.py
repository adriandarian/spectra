"""
Centralized constants for md2jira.
...
class ConfigFile:
    ...
    YAML_NAME: Final[str] = ".md2jira.yaml"
    YML_NAME: Final[str] = ".md2jira.yml"
    TOML_NAME: Final[str] = ".md2jira.toml"
    PYPROJECT: Final[str] = "pyproject.toml"
    
    # State directory
    STATE_DIR: Final[str] = ".md2jira"
    STATE_FILE: Final[str] = "state.json"
    BACKUP_DIR: Final[str] = "backups"
    CACHE_DIR: Final[str] = "cache"
    
    # pyproject.toml section
    PYPROJECT_SECTION: Final[str] = "tool.md2jira"
