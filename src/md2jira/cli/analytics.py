...
class AnalyticsConfig:
    ...
    # Storage
    data_dir: Optional[str] = None  # Defaults to ~/.md2jira/analytics
    ...
    def storage_path(self) -> Path:
        ...
        # Default to ~/.md2jira/analytics
        home = Path.home()
        return home / ".md2jira" / "analytics"
...
Data is stored locally at: ~/.md2jira/analytics/usage.json
