...
class ErrorFormatter:
    ...
    def format(self, exc: Exception) -> FormattedError:
        ...
        if isinstance(exc, Md2JiraError):
            return self._format_generic_md2jira_error(exc)
    ...
    def _format_config_error(self, exc: ConfigError) -> FormattedError:
        ...
        if "url" in message_lower:
            ...
            suggestions = [
                ...
                "Add 'jira.url' to your config file (.md2jira.yaml)",
            ...
            suggestions = [
                ...
                "Add 'jira.email' to your config file (.md2jira.yaml)",
            ...
            suggestions = [
                ...
                "Add 'jira.api_token' to your config file (.md2jira.yaml)",
    ...
    def _format_generic_md2jira_error(self, exc: Md2JiraError) -> FormattedError:
        """Format generic md2jira error."""
...
def format_config_errors(errors: list[str], color: bool = True) -> str:
    ...
    if color:
        ...
        lines.append(f"    {Colors.CYAN}3.{Colors.RESET} Or create a config file: .md2jira.yaml")
    else:
        ...
        lines.append("    3. Or create a config file: .md2jira.yaml")
    
    lines.append("")
    if color:
        lines.append(
            f"  {Colors.DIM}📖 Documentation: {Colors.RESET}"
            f"{Colors.BLUE}https://md2jira.dev/guide/configuration{Colors.RESET}"
        )
    else:
        lines.append("  📖 Documentation: https://md2jira.dev/guide/configuration")
