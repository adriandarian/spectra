...
class LinearTrackerPlugin(TrackerPlugin):
    ...
    Enables Linear integration through the md2jira plugin system.
    ...
    def __init__(self, config: Optional[dict[str, Any]] = None) -> None:
        ...
        self._adapter: Optional[LinearAdapter] = None
    ...
    def metadata(self) -> PluginMetadata:
        ...
        return PluginMetadata(
            name="linear",
            version="1.0.0",
            description="Linear integration for md2jira",
    ...
    def get_tracker(self) -> IssueTrackerPort:
        ...
        if not self.is_initialized or self._adapter is None:
            raise RuntimeError(
                "Linear plugin not initialized. Call initialize() first."
            )
...
def create_plugin(config: Optional[dict[str, Any]] = None) -> LinearTrackerPlugin:
    """
