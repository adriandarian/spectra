...
class NotionParserPlugin(ParserPlugin):
    ...
    Enables parsing of Notion exports through the md2jira plugin system.
    ...
    def __init__(self, config: Optional[dict[str, Any]] = None) -> None:
        ...
        self._parser: Optional[NotionParser] = None
    ...
    def metadata(self) -> PluginMetadata:
        ...
        return PluginMetadata(
            name="notion-parser",
            version="1.0.0",
            description="Notion export parser for md2jira",
    ...
    def get_parser(self) -> DocumentParserPort:
        ...
        if not self.is_initialized or self._parser is None:
            raise RuntimeError(
                "Notion parser plugin not initialized. Call initialize() first."
            )
        return self._parser


def create_plugin(config: Optional[dict[str, Any]] = None) -> NotionParserPlugin:
    """
